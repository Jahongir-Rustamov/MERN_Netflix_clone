...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        >
          <input
            ...
            className="p-2 rounded flex-1 bg-black/80 border border-gray-700 focus:ring focus:outline-none"
            value={email}
      ...
      <div className="flex bg-black text-white items-center text-center md:py-2 justify-center text-2xl md:text-2xl  ">
        <p>Build By </p>
        <Link
          to={"https://github.com/Jahongir-Rustamov?tab=repositories"}
          className="text-blue-500 px-0.5 hover:underline"
        >
          Jakhongir_Rustamov
        </Link>
      </div>
